...
string loadPasswordFromFile() {
 string loadPass;
  if (fin >> loadPass)
    ...
    cout << "No password.txt file located." << endl;
}
...
int main () {
  ...
  do {
    ...
    switch (userChoice) {
      case 'a':
      case 'A':
        cout << "Must be at least 8 characters long and contain at "
          << "least three out of the following four "
          << "types of characters." << endl
        ...
        cout << "Encrypted: " << manager.getEncryptedPassword() << endl;
        break;
